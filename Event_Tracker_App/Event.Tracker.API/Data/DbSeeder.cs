            ...
            {   
                var events = new List<EventModel>(){
                    new EventModel{
                        ...
                        DateTo = new DateTime(2024, 4, 19),
                        Description = "Music concert featuring P!NK at the Friends Arena in Solna. Feel the rhythm of the city as you enjoy live performances that cover a wide range of musical genres from jazz to classical.",
                        Duration = 3, 
                    ...
                    new EventModel{
                        ...
                        DateTo = new DateTime(2024, 5, 1),
                        Description = "Music concert featuring THE THE at the Filadelfia Convention Center. Feel the rhythm of the city as you enjoy live performances that cover a wide range of musical genres from jazz to classical.",
                        Duration = 2,  
                    ...
                    new EventModel{
                        ...
                        DateTo = new DateTime(2024, 4, 29),
                        Description = "Comedy event at Hotel Kung Carl featuring Tobias Persson and Shanthi Rydwall-Menon. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphe",
                        Duration = 2,
                    ...
                    new EventModel{
                        ...
                        DateTo = new DateTime(2024, 5, 2),
                        Description = "Dining and music experience in complete darkness at Svartklubben. Feel the rhythm of the city as you enjoy live performances that cover a wide range of musical genres from jazz to classical.",
                        Duration = 3, 
                    ...
                    new EventModel{
                        ...
                        Description = "Ghost walk around Stockholm starting outside the Nobel Museum. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphere.",
                        Duration = 2,
                    ...
                    new EventModel{
                        ...
                        Description = "Annual fashion week event showcasing the latest trends and designs. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphere.",
                        Duration = 4,  
                    ...
                    new EventModel{
                        ...
                        Description = "Intensive workshop on directing techniques for aspiring filmmakers. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphere.",
                        Duration = 6,  
                    ...
                    new EventModel{
                        ...
                        DateTo = new DateTime(2024, 4, 13),
                        Description = "An evening of fun and socializing for singles looking to meet new people. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphere.",
                        Duration = 4,  
                    ...
                    new EventModel{
                        ...
                        DateTo = new DateTime(2024, 4, 18),
                        Description = "A hands-on workshop focused on mastering portrait photography techniques. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphere.",
                        Duration = 5,  
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 15),
                        DateTo = new DateTime(2024, 4, 16),
                        Description = "Relax and rejuvenate with a full day spa retreat at Sturebadet Spa. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphere.",
                        Duration = 8,
                    ...
                    new EventModel {
                        ...
                        Description = "Compete in our annual squash tournament and showcase your skills. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphere.",
                        Duration = 8,
                    ...
                    new EventModel {
                        ...
                        Time = new DateTime(2024, 04, 01, 00, 00, 00),
                        Date = new DateTime(2024, 4, 21),
                        DateTo = new DateTime(2024, 4, 21),
                        Description = "Indulge in a variety of delicious street food from around the world at our festival. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosph",
                        Duration = 8,
                    ...
                    new EventModel {
                        ...
                        DateTo = new DateTime(2024, 4, 22),
                        Description = "Join industry leaders and innovators at our annual tech summit. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphere.",
                        Duration = 8,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 29),
                        DateTo = new DateTime(2024, 4, 29),
                        Description = "Try your hand at tennis and enjoy a fun-filled day at our open event. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphere.",
                        Duration = 4,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 5, 2),
                        DateTo = new DateTime(2024, 5, 2),
                        Description = "Experience luxury and exclusivity at our VIP cocktail party. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphere.",
                        Duration = 4,
                    ...
                    new EventModel {
                        ...
                        DateTo = new DateTime(2024, 4, 23),
                        Description = "Join us in making a positive impact on the environment by participating in a volunteer cleanup event. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in ",
                        Duration = 4,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 30),
                        DateTo = new DateTime(2024, 4, 30),
                        Description = "Learn wildlife photography techniques from experts at Skansen. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosphere.",
                        Duration = 4,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 21),
                        DateTo = new DateTime(2024, 4, 22),
                        Description = "Explore the flavors of Swedish wines on a guided tasting tour through Gamla Stan. Experience the exquisite craft of local winemakers and savor the complex flavors that only come from the finest vineya",
                        Duration = 2,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 29),
                        DateTo = new DateTime(2024, 4, 30),
                        Description = "Hone your storytelling skills at our short story writing workshop. Enhance your literary prowess through expert-led exercises that promise to sharpen your narrative techniques.",
                        Duration = 3,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 29),
                        DateTo = new DateTime(2024, 4, 29),
                        Description = "Find peace and serenity with an outdoor yoga session in Humlegården. Align your body and mind with the serene sounds of the sea as a backdrop, perfect for finding your inner peace.",
                        Duration = 2,
                    ...
                    new EventModel {
                        ...
                        Description = "Start your day with a refreshing morning run through the scenic trails of Djurgården. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmosp",
                        Duration = 1,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 15),
                        DateTo = new DateTime(2024, 4, 16),
                        Description = "Master the art of traditional Spanish paella in this hands-on cooking class right by the sea. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibran",
                        Duration = 3,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 23),
                        DateTo = new DateTime(2024, 4, 23),
                        Description = "Enjoy a vibrant evening of Latin music featuring top artists at a popular local venue. Feel the rhythm of the city as you enjoy live performances that cover a wide range of musical genres from jazz to",
                        Duration = 4,
                    ...
                    new EventModel {
                        ...
                        DateTo = new DateTime(2024, 4, 14),
                        Description = "Laugh out loud with Barcelona's finest comedians in the heart of the historic Gothic Quarter. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibran",
                        Duration = 2,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 13),
                        DateTo = new DateTime(2024, 4, 14),
                        Description = "Swing to the rhythm of salsa with enthusiasts from all over the world, right on Barceloneta Beach. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a v",
                        Duration = 3,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 27),
                        DateTo = new DateTime(2024, 4, 27),
                        Description = "Explore strategies for financial independence and wealth management with leading financial experts. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a ",
                        Duration = 4,
                    ...
                    new EventModel {
                        ...
                        DateTo = new DateTime(2024, 4, 25),
                        Description = "Join our beachfront gymnastics session to improve flexibility and core strength under the open sky. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a ",
                        Duration = 2,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 30),
                        DateTo = new DateTime(2024, 5, 1),
                        Description = "Dive into the heart of Catalan cuisine and learn to cook traditional dishes with local chefs. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibran",
                        Duration = 3,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 30),
                        DateTo = new DateTime(2024, 5, 1),
                        Description = "Enhance your Spanish speaking skills through practical immersion techniques in a friendly setting. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a v",
                        Duration = 6,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 12),
                        DateTo = new DateTime(2024, 4, 13),
                        Description = "Savor the tastes of Barcelona on a gourmet tour featuring top eateries and hidden gems. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibrant atmo",
                        Duration = 4,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 5, 2),
                        DateTo = new DateTime(2024, 5, 2),
                        Description = "Learn the sensual moves of salsa from experienced dancers in an inspiring beachfront setting. Don't miss this unique opportunity to engage with industry experts and like-minded enthusiasts in a vibran",
                        Duration = 2,
                    ...
                    new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 13),
                        DateTo = new DateTime(2024, 4, 13),
                        Description = "Experience an unforgettable night of live music under the stars at one of Barcelona's iconic open air venues. Feel the rhythm of the city as you enjoy live performances that cover a wide range of musi",
                        Duration = 3,
                     ...
                     new EventModel {
                        ...
                        Date = new DateTime(2024, 4, 30),
                        DateTo = new DateTime(2024, 4, 30),
                        Description = "Greet the day with a rejuvenating yoga session as the sun rises over the Mediterranean. Align your body and mind with the serene sounds of the sea as a backdrop, perfect for finding your inner peace.",
                        Duration = 2,
