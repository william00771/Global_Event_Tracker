                    ...
                    <header className='event-container__header'>
                        ...
                        <section className='event-container__header-bottom'>
                            ...
                            <div className='event-container__header-item'>
                                ...
                                <p className='event-container__header-paragraph'>{formatDateToStartDateEndDate(eventData!.date)}</p>
                            </div> 
                            <div className='event-container__header-item'>
                                ...
                                <p className='event-container__header-paragraph'>{formatDateAndDurationToHours(eventData!.date, eventData!.duration)}</p>
                            </div>
                            <div className='event-container__header-item'>
                        ...
                        <img className='event-container__header-bgimage' src="https://i.pinimg.com/564x/91/ef/f3/91eff36aa5b830a0e83cce8535133f43.jpg" alt="" />
                    </header>
