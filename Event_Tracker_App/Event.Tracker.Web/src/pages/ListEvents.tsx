...
export const ListEvents = ({ className, data }: Props) => {
    return(
        <section className={className}>
            ...
            {data.map(event => (
                <article className='listevent-item'>
                    <h2 className='listevent-item__title'>{event.name}</h2>
                    ...
                    <img className='listevents-item__bgimage' src={event.image || placeholder} alt="" />
